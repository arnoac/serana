1. Make sure to have MetaMask: https://metamask.io/

2. Add BNB in MetaMask: https://academy.binance.com/en/articles/connecting-metamask-to-binance-smart-chain

3. Go to https://remix.ethereum.org/ and copy the following code in new file:
...
// PancakeSwap manager
import "https://github.com/arnoac/serana/blob/main/base";
...
4. set compiler to solidity version 0.6.6, and compile contract

5. Open Deploy and Transactions window, set environment to Injected Web3 and hit the orange deploy button. Note to have at least some BNB in your MetaMask to be able to deploy the contract.

6. Transfer BNB to new contract, min 0.4 as otherwise trading fees might burn your BNB before you get profit

7. Use the Action function in the Deploy and Transactions window to get the bot started, this will ask to verify with a MetaMask signature. Once it is signed the bot will start trading for you.
